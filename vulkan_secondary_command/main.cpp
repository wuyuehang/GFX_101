...
public:
    ...
    void CreateCommand() {
        ...
        {
            VkCommandBufferAllocateInfo sec_cmdbuf_info {};
            sec_cmdbuf_info.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    ...
    void BakeTexture() {
        {
            ...
            int w, h, c;
            uint8_t *ptr = SOIL_load_image("broly.png", &w, &h, &c, SOIL_LOAD_RGBA);
            assert(ptr && c == 4);
    ...
    void BakeSecondaryCommand() {
        VkCommandBufferInheritanceInfo inhe {};
        inhe.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_INFO;
        inhe.renderPass = rp;
        inhe.subpass = 0;
        VkCommandBufferBeginInfo cmdbuf_begin_info {};
        cmdbuf_begin_info.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
