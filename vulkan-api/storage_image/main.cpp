...
class TestStorageImage : public SkeletonVulkan {
public:
    TestStorageImage() : SkeletonVulkan(VK_API_VERSION_1_0, 800, 800) {
        SkeletonVulkan::init();
        {
    ...
    void CreateStorageImage() {
        ...
        dst_texture->init(VkExtent3D { src_texture->get_width(), src_texture->get_height(), 1 }, VK_FORMAT_R8G8B8A8_UNORM,
            VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_SAMPLED_BIT,
            VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, VK_IMAGE_ASPECT_COLOR_BIT, 1);
        dst_texture->transition(VK_IMAGE_LAYOUT_GENERAL, VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT);
    ...
    void CreateDescriptor() {
        {
            ...
            std::vector<VkDescriptorSetLayoutBinding> bindings = {
                ...
                GfxDescriptorSetLayoutBinding(1, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1, VK_SHADER_STAGE_COMPUTE_BIT)
            };
        ...
        std::vector<VkDescriptorPoolSize> pool_size = {
            GfxDescriptorPoolSize(VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 2),
        ...
        vkAllocateDescriptorSets(dev, &alloc_info, ds.data());
        {
            ...
            std::vector<VkWriteDescriptorSet> w = {
                ...
                GfxWriteDescriptorSet(ds[0], 1, 1, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, &dst_texture->get_descriptor_info())
            };
    ...
    void CreateCOMPipeline() {
        auto comp = loadSPIRV(dev, "image_load_store.comp.spv");
