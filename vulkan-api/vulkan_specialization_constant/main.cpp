...
public:
    ...
    void InitGLFW() {
        ...
        window = glfwCreateWindow(800, 800, "specialization", nullptr, nullptr);
    }
    void CreateInstance() {
    ...
    void BakeTexture() {
        {
            ...
            int w, h, c;
            uint8_t *ptr = stbi_load("../resource/frieza.png", &w, &h, &c, STBI_rgb_alpha);
            assert(ptr && c == 4);
    ...
    void CreatePipeline() {
        ...
        auto frag_spv = loadSPIRV("specialization_constant.frag.spv");
        ...
        spec_info.mapEntryCount = entry.size();
        spec_info.pMapEntries = entry.data();
        spec_info.dataSize = sizeof(datum);
        spec_info.pData = &datum;
